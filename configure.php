...
const DUMPFILE = __DIR__.'/dumper/data.dump';//location of your DUMPFILE
const LINEBREAK = PHP_EOL.'-----------------------------------------------'.PHP_EOL;//linebreak used for the dump output
const DUMP_READ = 10000;//limit how many lines to process, leave as 0 to process all
